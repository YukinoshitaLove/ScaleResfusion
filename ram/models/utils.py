...
def init_tokenizer():
    # Set BERT_BASE_UNCASED_PATH to a local copy of bert-base-uncased to run offline.
    tokenizer = BertTokenizer.from_pretrained(os.environ.get('BERT_BASE_UNCASED_PATH', 'bert-base-uncased'))
    tokenizer.add_special_tokens({'bos_token': '[DEC]'})
    tokenizer.add_special_tokens({'additional_special_tokens': ['[ENC]']})
    # `additional_special_tokens_ids` was removed in transformers 5.x; look the id up directly.
